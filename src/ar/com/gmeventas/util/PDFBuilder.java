...
public class PDFBuilder {
    ...
    public File armarFacturaA(IvaVentas iv, List<RenglonFactura> rf) throws FileNotFoundException, DocumentException, Exception {
        ...
        FileOutputStream ficheroPdf = new FileOutputStream("c:/ventasF/data/facturas/" + fileNameFormatted + ".pdf");
        ...
        PdfPCell celdaEncabezado1 = new PdfPCell(new Paragraph("SAVID FERNANDO MARTIN", FontFactory.getFont("arial", 9, Font.BOLD, NEGRO)));
        ...
        PdfPCell celdaEncabezado4 = new PdfPCell(new Paragraph("Razón Social: Savid Fernando Martin", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        ...
        PdfPCell celdaEncabezado7 = new PdfPCell(new Paragraph("Dirección: Av. Avellaneda 4038", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        ...
        PdfPCell celdaEncabezado10 = new PdfPCell(new Paragraph("CP. 1646 - VIRREYES", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado11 = new PdfPCell(new Paragraph(" ", FontFactory.getFont("arial", 8, Font.PLAIN, NEGRO)));
        PdfPCell celdaEncabezado12 = new PdfPCell(new Paragraph("C.U.I.T.: 20-25084492-2", FontFactory.getFont("arial", 8, Font.PLAIN, NEGRO)));
        ...
        PdfPCell celdaEncabezado15 = new PdfPCell(new Paragraph("Ing.Brutos Nro.: 20-25084492-2", FontFactory.getFont("arial", 8, Font.PLAIN, NEGRO)));
        ...
        PdfPCell celdaEncabezado18 = new PdfPCell(new Paragraph("Inicio Actividad: 03/2021", FontFactory.getFont("arial", 8, Font.PLAIN, NEGRO)));
...
//            pdf.add(new Paragraph("ESPACIO EN BLANCO", FontFactory.getFont("arial", 8, PLAIN, FONDO_BLANCO)));
        ...
        com.itextpdf.text.Font font = FontFactory.getFont("C:/ventasF/fonts/PF_I2OF5_TXT.ttf",
        ...
        Image imagen = Image.getInstance("c:/ventasF/qr/CodigoQR" + nr0 + ".png");
        Image img2 = Image.getInstance("c:/ventasF/qr/afip.png");
        ...
        return new File("c:/ventasF/data/facturas/" + fileNameFormatted + ".pdf");
...
//        }
    ...
    public File armarFacturaB(IvaVentas iv, List<RenglonFactura> rf) throws FileNotFoundException, DocumentException, Exception {
        ...
        FileOutputStream ficheroPdf = new FileOutputStream("c:/ventasF/facturas/" + fileNameFormatted + ".pdf");
...
//            pdf.add(new Paragraph("ESPACIO EN BLANCO", FontFactory.getFont("arial", 8, PLAIN, FONDO_BLANCO)));
        ...
        pdf.close();
        return new File("c:/ventasF/facturas/" + fileNameFormatted + ".pdf");
    }
