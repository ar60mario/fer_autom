...
public class FacturarFrame extends javax.swing.JFrame {
    ...
    private String userdir = "c:/ventasF/crt";
...
//                }
        ...
        // Double minNro = cf.getImporteMinimo();
...
//            JOptionPane.showMessageDialog(this, "Hello");
    ...
    private void nuevo() {
        ...
        try {
            ...
            if (ff.after(new Date())) {
                JOptionPane.showMessageDialog(this, "FECHA POSTERIOR AL DIA DE HOY - ESCRIBA UNA VALIDA");
                return;
            }
        } catch (ParseException ex) {
            Logger.getLogger(FacturarFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void limpiarCampos() {
        ...
        variosRb.setSelected(false);
        segundosTxt.setText("12");
        segun2Txt.setText("25");
        Long c = 1L;
...
//                System.exit(0);
                if (fws.after(new Date())) {
                    JOptionPane.showMessageDialog(this, "ERROR EN FECHA DEBE SER IGUAL O MENOR QUE HOY");
                    return;
                }
                ultimaFechaFc = fws;
                if (tst == 0) {
...
//                            System.exit(0);
                            ...
                            String ruta1 = "c:/ventasF/cmprbte/" + tipoComprob
                                    + letraFacturaPapel + sucursalFacturaPapel
                                    + "_" + numeroFacturaPapel + ".xm1";
                            String ruta2 = "c:/ventasF/cmprbte/" + tipoComprob
                                    + letraFacturaPapel + sucursalFacturaPapel
                                    + "_" + numeroFacturaPapel + ".xm2";
                            File archivo1 = new File(ruta1);
                            File archivo2 = new File(ruta2);
                            BufferedWriter bw1, bw2;
                            bw1 = new BufferedWriter(new FileWriter(archivo1));
                        ...
                        JOptionPane.showMessageDialog(this, "ERROR exception 1361 " + e);
//                        e.printStackTrace();
                        return;
                    }
                }
