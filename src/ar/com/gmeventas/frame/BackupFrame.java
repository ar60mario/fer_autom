...
public class BackupFrame extends javax.swing.JFrame {
    ...
    private void backup() {
        ...
        try {
            Process p = null;
            String filepath = "C:/ventasF/backup/bkp_fernando_db.sql";
            String batchCommand = "";
            batchCommand = "c:/ventasF/bin/mysqldump.exe" + " -h " + "localhost" + " --port " + "3306" + " -u " + "root" + " --password=root fer_vta" + " -r " + filepath;
            Runtime runtime = Runtime.getRuntime();
            p = runtime.exec(batchCommand);
            int processComplete = p.waitFor();
            if (processComplete == 0) {
                status = true;
                JOptionPane.showMessageDialog(this,"Backup creado correctamente DB\n" + "FERNANDO en C:/VENTASF/BACKUP");
            } else {
                status = false;
                JOptionPane.showMessageDialog(this,"Error creando Backup DB " + "FERNANDO en C:/VENTASF/BACKUP");
            }
