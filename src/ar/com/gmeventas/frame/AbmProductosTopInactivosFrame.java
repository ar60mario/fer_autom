...
public class AbmProductosTopInactivosFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("ABM PRODUCTOS UTILIZADOS INACTIVOS");
        ...
        tablaProductos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Orden", "Código", "Detalle", "Activo", "Precio", "STOCK"
            }
        ) {
    ...
    private void modificar() {
        ...
        if(a==0){
            try {
                ...
                JOptionPane.showMessageDialog(this, "PRODUCTO UTILIZADO ACTIVADO");
            } catch (Exception ex) {
                Logger.getLogger(AbmProductosTopInactivosFrame.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "ERROR 240 - PRODUCTO UTILIZADO NO ACTIVADO");
                return;
            }
            llenarTabla();
        }
